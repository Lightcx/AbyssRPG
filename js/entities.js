...
(function (root) {
  ...
  ENT.makeMonster = function (game, defId, x, y, opts) {
    ...
    const m = {
      ...
      dmg: def.dmg * dmgMul, armor: G.monsterArmor(def.armor, mlvl, game.diffIdx),
      ...
      res: G.monsterResists(mlvl, game.diffIdx), dodgeChance: 0, onHitElem: null, deathNova: null, lifesteal: 0, aura: null,
  ...
  ENT.makeBoss = function (game, bossId, x, y) {
    ...
    const m = {
      ...
      armor: G.monsterArmor(bd.armor, mlvl, game.diffIdx), speed: bd.speed,
      ...
      dots: [], chargeCd: 0, summonCd: 0, res: G.monsterResists(mlvl, game.diffIdx), dodgeChance: 0, onHitElem: null, deathNova: null,
